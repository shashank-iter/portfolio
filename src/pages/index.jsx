...
function Resume() {
  let resume = [
    ...
    {
      company: 'Skillvalley',
      title: 'Developer and Cohort Manager',
      logo: logoSkillvalley,
      start: 'March 2023',
      end: 'Jul 2023',
    },
    {
      ...
      <Head>
        ...
        <meta
          ...
          content="I’m Shashank, a software developer and project manager based in
            India. I love building functional UIs and scalable backends. Got a
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software developer, builder, and project manager.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Shashank, a software developer and project manager based in
            India. I love building functional UIs and scalable backends. Got a
            project in mind? Let’s talk.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/shashank_iter"
